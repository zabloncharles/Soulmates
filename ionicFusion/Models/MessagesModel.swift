...
var messageContent = [
    ...
    MessageUser(name: "Ced Rits", message: "Hey bro", numberofmessages: 3, avatar: "cover1", background: "cover2", online: false),
    MessageUser(name: "Jim Stiller", message: "Hey bro", numberofmessages: 3, avatar: "cover2", background: "cover2", online: false),
    MessageUser(name: "Terr Gill", message: "Hey bro", numberofmessages: 3, avatar: "cover4", background: "cover2", online: false),
    MessageUser(name: "Ben Stiller", message: "Hey bro", numberofmessages: 3, avatar: "cover5", background: "cover2", online: false),
    MessageUser(name: "Nija Wersa", message: "Hey bro", numberofmessages: 3, avatar: "cover6", background: "cover2", online: false)
